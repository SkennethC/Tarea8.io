...
function Registrar()
{
    ...
    const table = document.getElementById("Producto_Seleccionado");
    ...
    if (producto.value === "Rosas")
    {
        precio = 10350;
    }
    else
    {
        if (producto.value === "Girasoles")
        {
            precio = 11825;
        }
    }
...
function MostrarTotal()
{
    ...
    lblTotal.innerHTML = "El total a pagar es de: " + Total;
}
...
function Limpiar()
{
    const table = document.getElementById("Producto_Seleccionado");
    const rows = table.getElementsByTagName("tr");
    const TxtTotal = document.getElementById("lblTotal");
